...
public  class DataManager : MonoBehaviour
{
    ...
    public void GetPost()
    {
        ...
        for (int i = 0; i < postListJson.Count; i++)
        {
            ...
            postItem.title=postItem.title.Replace("sumPowerRanking", "합계파워 랭킹");
            postItem.title=postItem.title.Replace("maxPowerRanking", "최고파워 랭킹");
            postItem.title=postItem.title.Replace("averageRanking", "평균파워 랭킹");
